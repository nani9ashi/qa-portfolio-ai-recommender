 ...
 * 単元マスタデータ (バックエンド用)
 *
 * Source of truth: src/units.js
 * 本ファイルはバックエンドからの参照のため再実装している。
 * src/units.js を変更した際は本ファイルも同期更新すること。
 *
 * 将来的には src/units.js を ES Module 化して共通参照する形にリファクタする
 * 余地があるが、本ポートフォリオのスコープでは二重管理を許容している。
 */
...
module.exports = { UNITS, GRADE_ORDER, getUnitsForGrade, findUnitById };
