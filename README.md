...
# 初回のみ: テスト用 .env を作成 (デフォルト設定で問題なければ編集不要)
...
# 結果は tests/ai-quality/results/YYYY-MM-DD_HH-MM-SS/ に summary.json + details.csv で出力
```
...
| AI 出力品質テスト Phase 1 (ルールベース判定) | 完成 |
| AI 出力品質テスト Phase 2 (LLM-as-a-judge) | 実装予定 |
